...
function get_user_with_uuid(string $uuid, \Doctrine\ORM\EntityRepository $loggedUserRep)
{
...
if (isset($_GET['uuid'])) {
    ...
    die_with_http_code_json(200, ["success" => true, "users" => $loggedUserRep->findAll()]);
}